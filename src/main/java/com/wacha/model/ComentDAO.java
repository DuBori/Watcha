	...
	// DB와 연동하는 객체.
		...
		public List<ContentDTO> userContentComentList(String id) {
			...
			try {
				...
				sql="select m.movie_title ,c.movie_num, c.coment_num, c.coment_num_son, c.moive_coment, c.member_id, c.coment_hit, c.coment_nohit from coment c, movie m where m.movie_num = c.movie_num and member_id =?";
				...
				dto.setMovie_coment(rs.getString("moive_coment"));
